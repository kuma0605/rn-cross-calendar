import { memo, forwardRef, useState, useMemo, useRef, useCallback, useEffect, useImperativeHandle } from 'react';
import { StyleSheet, useColorScheme, View, TouchableOpacity, Text, Animated } from 'react-native';
...
function CalendarHeaderInner({
  ...
  return /* @__PURE__ */ jsxs(View, { style: styles.row, children: [
    /* @__PURE__ */ jsx(View, { style: styles.leftPlaceholder }),
    /* @__PURE__ */ jsxs(View, { style: styles.centerBlock, children: [
      /* @__PURE__ */ jsx(
        TouchableOpacity,
        {
          style: styles.arrow,
          ...
          onPress: onPrev,
          children: /* @__PURE__ */ jsx(View, { style: [styles.chevronLeft, { borderColor: textColor }] })
        }
      ),
      /* @__PURE__ */ jsx(
        TouchableOpacity,
        {
          ...
          children: /* @__PURE__ */ jsx(Text, { style: [styles.titleText, { color: textColor }], children: title })
        }
      ),
      /* @__PURE__ */ jsx(
        TouchableOpacity,
        {
          ...
          hitSlop: { top: 10, bottom: 10, left: 10, right: 10 },
          onPress: onNext,
          children: /* @__PURE__ */ jsx(View, { style: [styles.chevronRight, { borderColor: textColor }] })
        }
      )
    ] }),
    /* @__PURE__ */ jsx(View, { style: styles.rightBlock, children: onTodayPress && /* @__PURE__ */ jsx(
      TouchableOpacity,
      {
        style: [styles.todayTag, { backgroundColor: themeColor + "1A" }],
        activeOpacity: 0.7,
        onPress: onTodayPress,
        children: /* @__PURE__ */ jsx(Text, { style: [styles.todayText, { color: themeColor }], children: todayLabel })
      }
    ) })
  ] });
}
var CalendarHeader = memo(CalendarHeaderInner);
...
function CalendarDayInner({
  ...
  return /* @__PURE__ */ jsxs(
    TouchableOpacity,
    {
      ...
      onPress: handlePress,
      children: [
        inRangeContext && /* @__PURE__ */ jsx(View, { style: styles2.rangeBg, children: /* @__PURE__ */ jsx(View, { style: [styles2.rangeStrip, rangeBg] }) }),
        /* @__PURE__ */ jsx(
          Animated.View,
          {
            style: [
            ...
            children: /* @__PURE__ */ jsx(Text, { style: [styles2.text, { color: labelColor }], children: dayNumber })
          }
        ),
        /* @__PURE__ */ jsx(View, { style: styles2.extra, children: custom !== void 0 ? custom : dotColor ? /* @__PURE__ */ jsx(View, { style: [styles2.dot, { backgroundColor: dotColor }] }) : null })
      ]
    }
  );
}
var CalendarDay = memo(CalendarDayInner);
...
function CalendarGridInner(props) {
  ...
  return /* @__PURE__ */ jsxs(View, { children: [
    /* @__PURE__ */ jsx(View, { style: styles3.headerRow, children: headers.map((h, idx) => /* @__PURE__ */ jsx(View, { style: styles3.headerCell, children: /* @__PURE__ */ jsx(Text, { style: [styles3.headerText, { color: textSecondary }], children: h }) }, `${h}-${idx}`)) }),
    rows.map((row, ri) => /* @__PURE__ */ jsx(View, { style: styles3.row, children: row.map((cell) => /* @__PURE__ */ jsx(
      CalendarDay,
      {
        meta: cell,
        themeColor,
...
var CalendarGrid = memo(CalendarGridInner);
...
function YearPanelInner({
  ...
  return /* @__PURE__ */ jsx(View, { style: styles4.wrap, children: rows.map((row, ri) => /* @__PURE__ */ jsx(View, { style: styles4.row, children: row.map((mIdx) => {
      ...
      TouchableOpacity,
      {
        ...
        children: /* @__PURE__ */ jsx(
          View,
          {
            ...
            children: /* @__PURE__ */ jsx(Text, { style: [styles4.text, { color: labelColor }], children: monthLabels[mIdx] })
          }
        )
      },
      ym
...
var YearPanel = memo(YearPanelInner);
...
var Calendar = forwardRef((props, ref) => {
  const {
    mode = "single",
    value,
    defaultValue,
  ...
  const isValueControlledRef = useRef(value !== void 0);
  if (value !== void 0) {
    isValueControlledRef.current = true;
  }
  const isValueControlled = isValueControlledRef.current;
  const isPanelControlledRef = useRef(panelDate !== void 0);
  if (panelDate !== void 0) {
  ...
  const pickStepRef = useRef("start");
  ...
  const [innerPanel, setInnerPanel] = useState(
    () => toYM(
      parsePanel(
  ...
  return /* @__PURE__ */ jsxs(View, { style: [styles5.wrap, { backgroundColor: colors.surface }, style], children: [
    /* @__PURE__ */ jsx(
      CalendarHeader,
      {
        title: titleText,
...
export { Calendar, LOCALE_EN, LOCALE_ZH, MONTH_LABELS_CN, WEEKDAY_LABELS_CN, addMonths, addYears, buildMonthMatrix, formatMonthTitle, formatYearTitle, getWeekHeaders, isInRange, isSameDay, parseDate, parsePanel, sortRange, toYM, toYMD };
